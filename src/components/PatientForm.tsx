...
export const PatientForm = () => {
  ...
  const registerPatient = (data: DraftPatient) => {
    if (activeId) {
      updatePatient(data);
      toast.success("El paciente se ha actualizado correctamente", {
        theme: "colored",
      });
    } else {
      addPatient(data);
      toast.success("El paciente ha sido registrado exitosamente", {
        theme: "colored",
      });
    }
    reset();
      ...
      >
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            {...register("symptoms", {
              required: "Ingrese los síntomas del paciente",
              minLength: {
                value: 10,
